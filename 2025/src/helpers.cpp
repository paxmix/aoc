...
static constexpr std::array<Factory, NUM_DAYS> factories = {
    &create<Day1>, &create<Day2>, &create<Day3>, &create<Day4>,  &create<Day5>,  &create<Day6>,
    &create<Day7>, &create<Day8>, &create<Day9>, &create<Day10>, &create<Day11>, &create<Day12>,
};
...
void run(int day, int part)
{
    ...
    if (!answer.empty()) {
        std::println("Year 2025 Day {} Part {} answer is {}", day, part, answer);
    }
}
